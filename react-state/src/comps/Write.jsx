...
const Write = ({ bbs, onBBsChange }) => {
  const { b_date, b_time, b_write, b_subject, b_content } = bbs;
  return (
    <div className="bbs_write_form">
      ...
      <div>
        <label>글쓴이</label>
        <input name="b_writer" defaultValue={b_write} onChange={onBBsChange} />
      </div>
      <div>
        <label>제목</label>
        <input
