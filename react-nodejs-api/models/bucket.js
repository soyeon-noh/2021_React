 ...
 * 함수, method 등을 이용하여 CRUD를 쉽게 구현할 수 있도록 만들어진 도구
 ...
 * 편리할 때가 있다.
 * mongoos 를 사용하면
 * NoSQL이 마치 Schema가 있는 RDBMS처럼 사용할 수 있다.
 *
 */
...
// 생성한 Schema 구조로 buketList라는 Colletction(table)을
// 생성하여 사용하겠다.
module.exports = mongoose.model("bucketList", bucket);
// 여기이름의 복수형 만들어짐 (bucketlists)
